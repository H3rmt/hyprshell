...
tar --zstd -cf /tmp/hyprshell-aarch64.tar.zst --transform 's,.*/,,' LICENSE THIRD_PARTY_NOTICES.md README.md docs/CONFIGURE.md docs/DEBUG.md target/aarch64-unknown-linux-gnu/release/hyprshell packaging/hyprshell.service packaging/hyprshell-settings.png packaging/hyprshell-settings.desktop packaging/usr-share.tar
...
tar --zstd -cf /tmp/hyprshell-slim-aarch64.tar.zst --transform 's,.*/,,' LICENSE THIRD_PARTY_NOTICES.md README.md docs/CONFIGURE.md docs/DEBUG.md target/aarch64-unknown-linux-gnu/release/hyprshell packaging/hyprshell.service packaging/hyprshell-settings.png packaging/hyprshell-settings.desktop packaging/usr-share.tar
