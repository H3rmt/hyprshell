...
## [4.0.0](https://github.com/H3rmt/hyprshell/compare/v4.3.0...v4.0.0) (2025-06-21)


### Features

* add animation to plugin close launch ([b944274](https://github.com/H3rmt/hyprshell/commit/b9442742b5a357966061c66e594b9104d158fe7b))
* add calc plugin ([06c8a41](https://github.com/H3rmt/hyprshell/commit/06c8a41db42d482b777f158fcf9eb1b23708cc13))
* add debug command ([00afa1e](https://github.com/H3rmt/hyprshell/commit/00afa1e34b9716a041d3bd33734700836075bd70))
* Add NixOS `home-manager` module ([cd20717](https://github.com/H3rmt/hyprshell/commit/cd207178a0cfd44c7ad1069880ef35532f5547ae))
* add run shell commands from launcher ([879cbba](https://github.com/H3rmt/hyprshell/commit/879cbba0597281c14b07dadfe03149b4323caf6f))
* add websearch plugin ([1a079d1](https://github.com/H3rmt/hyprshell/commit/1a079d1552036f8713ba69f33271475ff4a41103))
* added `data` command to see LaunchHistory ([8e3de53](https://github.com/H3rmt/hyprshell/commit/8e3de53b31834c8a034d28d26d72ebcbbd4d9815))
* added click on clients and workspaces in overview and switch ([328fc3b](https://github.com/H3rmt/hyprshell/commit/328fc3b432b28ad1e390be10f945e1425708d430))
* added config file migrations ([db2f6cd](https://github.com/H3rmt/hyprshell/commit/db2f6cd9fb3c08ab2f9858fb9c1dac61540353b5))
* added custom args for hyprshell systemd ([aa01139](https://github.com/H3rmt/hyprshell/commit/aa01139aebfe2dcd717b670ac6ce557f93c2f1d0))
* added kill_bind if hyprshell crashes ([5e0b0fa](https://github.com/H3rmt/hyprshell/commit/5e0b0fa2cf8b7c7d4902fafff0b0dc4b2d03a84a))
* added show_when_empty ([6f916d5](https://github.com/H3rmt/hyprshell/commit/6f916d5b0355293eb0d4007b3c996deddb943c0d))
* added systemd generation (use --no-systemd to disable) ([97c2c7f](https://github.com/H3rmt/hyprshell/commit/97c2c7f88c3ba221863a43b8adbfb50b444fa841))
* better debug commands ([b17a393](https://github.com/H3rmt/hyprshell/commit/b17a393b04201beab8b582a340d1bb80bef5cda2))
* better parsing of desktop files(ini) to add DesktopActions in launcher ([a304809](https://github.com/H3rmt/hyprshell/commit/a3048098b1702277cf25e0454e0a7dd3d48c61ee))
* better window selection on empty workspace ([24b36b3](https://github.com/H3rmt/hyprshell/commit/24b36b38cc0b127fe2de2a59c223936ffc9c988e))
* click on entry in launcher works ([87076ef](https://github.com/H3rmt/hyprshell/commit/87076ef8c715fc0f7e29a7c2187aa59f17514df5))
* faster open speeds by applying submaps earlier ([a304809](https://github.com/H3rmt/hyprshell/commit/a3048098b1702277cf25e0454e0a7dd3d48c61ee))
* **nix:** Add `show_when_empty` ([8ebb333](https://github.com/H3rmt/hyprshell/commit/8ebb333cd0dad0ff919ea1790136c8e6120d4560))
* NixOS Support ([#171](https://github.com/H3rmt/hyprshell/issues/171)) ([d42f12b](https://github.com/H3rmt/hyprshell/commit/d42f12be62c08d3764bc91b034bc7aa05d531608))
* rewrite hyprswitch ([198cd0f](https://github.com/H3rmt/hyprshell/commit/198cd0f5ae03210b46cfaba8dbf5f8d30fcc77a9))
* rewrite hyprswitch ([0d834ab](https://github.com/H3rmt/hyprshell/commit/0d834ab64cb607d2bc10ca7b13d2642728592f50))
* switch to gtk key handling ([65a0ad5](https://github.com/H3rmt/hyprshell/commit/65a0ad5f482707cab8339c3c01195ff9b5557c1a))


### Bug Fixes

* add aur publish ([fc4f9ab](https://github.com/H3rmt/hyprshell/commit/fc4f9ab4f040646ff075930a86457bf7d4f3e77c))
* add HYPRSHELL_RELOAD_TIMEOUT to change timeout ([764cbb2](https://github.com/H3rmt/hyprshell/commit/764cbb211ee0a2a1382443b34e58e8a4a035fdb9))
* add nix back ([9efadcd](https://github.com/H3rmt/hyprshell/commit/9efadcdc37ae0c639ab36a1880e3d48b1b6c51a2))
* add show_actions_submenu with default false ([c0828d6](https://github.com/H3rmt/hyprshell/commit/c0828d6706157728e4af7742a8e97f7190a8eec0))
* added the PKGBUILD for arch ([93ca69b](https://github.com/H3rmt/hyprshell/commit/93ca69b15061f4ad8e4f1bcb674dba59c278571b))
* allow hold of tab and arrow keys to switch ([e0aaa57](https://github.com/H3rmt/hyprshell/commit/e0aaa570f54fce0155631c5720805886a0c275a1))
* arrow keys in the launcher ([179ca7b](https://github.com/H3rmt/hyprshell/commit/179ca7b45e865875584a4c658a0455ea00af0bc6))
* background loading of icons ([f5c8ff0](https://github.com/H3rmt/hyprshell/commit/f5c8ff0e29713432726bb841bafd8dd6729331fa))
* better icon detection ([453888e](https://github.com/H3rmt/hyprshell/commit/453888e61551946cfa3dec92409df606f7aa04db))
* check for config file extensions at start ([7a41bb2](https://github.com/H3rmt/hyprshell/commit/7a41bb2bf8abea7b2bc2efc2544deb26243faf7c))
* ci release ([4a0f45f](https://github.com/H3rmt/hyprshell/commit/4a0f45f466d47a12e6cab70d2e71c835287287a0))
* close launcher on esc ([a003b82](https://github.com/H3rmt/hyprshell/commit/a003b8227b709a7bb186e2b3703ec70f3f16dd7d))
* close socket after restarting app ([b4a8f2e](https://github.com/H3rmt/hyprshell/commit/b4a8f2e61d503fb6eee7850ce1ce6f33dfab72bf))
* debounce reload ([5858cfd](https://github.com/H3rmt/hyprshell/commit/5858cfd475f1e3b604f6d035bdc5507977833af5))
* **deps:** update rust crate clap to v4.5.40 ([19272f4](https://github.com/H3rmt/hyprshell/commit/19272f40aec98c2820919f4d5924533f12b15fc9))
...
* **deps:** update rust crate toml to v0.8.23 ([6268be8](https://github.com/H3rmt/hyprshell/commit/6268be8a74f85eb90dc1d7d94a5057ce6534ce89))
* detect socat path at runtime ([312f667](https://github.com/H3rmt/hyprshell/commit/312f6677165a023466a115d8a61f2927b31adc71))
* diable gestures and input:follow_mouse on start and reset after close ([6a516b2](https://github.com/H3rmt/hyprshell/commit/6a516b23e9124f577e16d2475962f8e3347237ae))
* don't exit launcher when no items ([a4356b7](https://github.com/H3rmt/hyprshell/commit/a4356b783c148f61736fcd9e4af23d63b1be7c85))
* don't unset all CSS styles at the start, only necessary ([b42d25c](https://github.com/H3rmt/hyprshell/commit/b42d25c1d342d10a5af378e1ebcae167a83ca01f))
* file watchers work again ([73c7ebf](https://github.com/H3rmt/hyprshell/commit/73c7ebf0914442c85b8af49e920fdbdd87be10a9))
* filter apps in the launcher by name, exec and details ([ab0f23e](https://github.com/H3rmt/hyprshell/commit/ab0f23e43c4ce540e14fe3f0ac515fa52ec56ab9))
* fix ci publish ([bb1e659](https://github.com/H3rmt/hyprshell/commit/bb1e65987ac7c371b29cbf09000bb4f117f5b0e9))
* fix ci release ([e498ca1](https://github.com/H3rmt/hyprshell/commit/e498ca19f86fcf2d4668fa7582f9320232fd194d))
* fix ci release ([6dc00c7](https://github.com/H3rmt/hyprshell/commit/6dc00c719ef7beaea70c86f7851c6de8cdf9117e))
...
* fix focus window problem ([3c702a1](https://github.com/H3rmt/hyprshell/commit/3c702a1da63d56168aa6e7ba2932842c55f97c8d))
* fix multiple run week caches not being added together ([c027209](https://github.com/H3rmt/hyprshell/commit/c027209d6f01ec10210420182ea3283380f8e74f))
* Fix Nix Build ([02bd2c4](https://github.com/H3rmt/hyprshell/commit/02bd2c400616cb96cd21ccc6b2f530143fcb511b))
* fix overflow for selecting workspaces ([9efadcd](https://github.com/H3rmt/hyprshell/commit/9efadcdc37ae0c639ab36a1880e3d48b1b6c51a2))
* fix overview click on client or workspace ([71d445c](https://github.com/H3rmt/hyprshell/commit/71d445c0f310f986b769eb420b55e21e9559d94d))
* fix panic when listening for changes on nonexisting file ([2e02509](https://github.com/H3rmt/hyprshell/commit/2e025099b4b259844a6f5192a4e9db3db10a00ba))
* fix right alt bind ([4394240](https://github.com/H3rmt/hyprshell/commit/43942408b0febe18026e278d2e4cffd7eece25db))
* fix run programs ([3997d2a](https://github.com/H3rmt/hyprshell/commit/3997d2a85e77d2d0e3a6799b17518ad5886aca74))
* fix slow start times ([0c4bb95](https://github.com/H3rmt/hyprshell/commit/0c4bb9585806de61f73e885026083e49b2fe2048))
* fix storage of input:follow_mouse setting ([62ab0f2](https://github.com/H3rmt/hyprshell/commit/62ab0f2f90a7235e3e2d6a8aa9267ebff4c16348))
* fix switch mode monitor select ([b8c1d44](https://github.com/H3rmt/hyprshell/commit/b8c1d440d47fe4a6ca2c1690e1b0be65b81de1df))
* fix systemd exit ([26ae103](https://github.com/H3rmt/hyprshell/commit/26ae103729696a02069c873bad76c2edbe9dcdf6))
* fix versions ([899b2cc](https://github.com/H3rmt/hyprshell/commit/899b2cc95018a342c2bf45d0fdf0ef971616be7b))
* fix versions ([e9565fd](https://github.com/H3rmt/hyprshell/commit/e9565fd627c85ed4fa8fcf26cd35c06ceeaeb2b7))
* fix versions ([8d9a5ee](https://github.com/H3rmt/hyprshell/commit/8d9a5eeeee5d74fef9501fec39c5d8692061ec97))
* fix versions ([05f3da6](https://github.com/H3rmt/hyprshell/commit/05f3da60197e59d6a882fa0282127ae62091f879))
* fix versions ([b4e0380](https://github.com/H3rmt/hyprshell/commit/b4e0380cced9b3ae35e3d8368fb336edc5530274))
* fix versions ([14e4a72](https://github.com/H3rmt/hyprshell/commit/14e4a725dfe6b0d70c235db80069238338ec2890))
* fix versions ([89711a6](https://github.com/H3rmt/hyprshell/commit/89711a628c45d6286742ac274ad4ec2fe487faed))
* fix wrong name in hm module ([99386d5](https://github.com/H3rmt/hyprshell/commit/99386d56c0e40e65bc491e2b87cf28ef83305f6d))
* fixed icon scaling ([5a0489a](https://github.com/H3rmt/hyprshell/commit/5a0489a39742d89abed3760096c3dccee2fa5845))
* fixed the PKGBUILD for arch ([89c06ba](https://github.com/H3rmt/hyprshell/commit/89c06baa318157827e7042adeaa4ca274b251756))
* force command now accepts args ([7a41bb2](https://github.com/H3rmt/hyprshell/commit/7a41bb2bf8abea7b2bc2efc2544deb26243faf7c))
* get socat path at buildtime ([a4356b7](https://github.com/H3rmt/hyprshell/commit/a4356b783c148f61736fcd9e4af23d63b1be7c85))
* handle sigterm and reset submap ([1516024](https://github.com/H3rmt/hyprshell/commit/1516024a04d46f4433f52984197bf6f39eeee6a6))
* improved file watcher, file descriptor limit was reached if reloaded too many times ([b4a8f2e](https://github.com/H3rmt/hyprshell/commit/b4a8f2e61d503fb6eee7850ce1ce6f33dfab72bf))
* make css optional ([b0c36ee](https://github.com/H3rmt/hyprshell/commit/b0c36eeb3f9dfbe9a85933505dc618cd0c231308))
* more debugging for default browser to fix [#188](https://github.com/H3rmt/hyprshell/issues/188) ([551bfd0](https://github.com/H3rmt/hyprshell/commit/551bfd0b58aedbccc93236595beab63dcf9195dc))
* move scripts ([97329b7](https://github.com/H3rmt/hyprshell/commit/97329b723d4c90e674fa74d65fb4397252266b85))
* moved size_factor to scale for a more sensible default and bounds check ([a85f3b8](https://github.com/H3rmt/hyprshell/commit/a85f3b8948211711acf232b9834f4c9c2afadf61))
* nix allow source and text attributes ([dcd9e41](https://github.com/H3rmt/hyprshell/commit/dcd9e417071e80cfd489eaefc8908a6b12a324eb))
* nix json config fixes ([ced4a45](https://github.com/H3rmt/hyprshell/commit/ced4a45ef6b8361663b30062298f3084f2219a37))
* **nix:** Fix HM Module ([b8367b4](https://github.com/H3rmt/hyprshell/commit/b8367b4de9dcd2a5b6e49a3e9322534657de4886))
* open windows earlier ([b42d25c](https://github.com/H3rmt/hyprshell/commit/b42d25c1d342d10a5af378e1ebcae167a83ca01f))
* release workflow now uses deploy keys ([e2c9b89](https://github.com/H3rmt/hyprshell/commit/e2c9b89f10505a6617f74b3e05c4129b162029ec))
* reload desktop maps on close ([204358d](https://github.com/H3rmt/hyprshell/commit/204358dc20ad49ff44d79444f707d20a4535d0da))
* remove launch animation from plugins after close ([685b7bd](https://github.com/H3rmt/hyprshell/commit/685b7bdf205cafc48e9a21aaccd9428e774905d9))
* remove size_factor from config ([77b53bd](https://github.com/H3rmt/hyprshell/commit/77b53bd205d32c0619d244a601cea8304f4a4b9c))
* remove socat dependency ([01758a6](https://github.com/H3rmt/hyprshell/commit/01758a6d6384c5ad73a841c3f2e8b90ee9912393))
...
* search for installed terminals from PATH ([453888e](https://github.com/H3rmt/hyprshell/commit/453888e61551946cfa3dec92409df606f7aa04db))
* selecting a client with filtering form workspace without an enabled client now selects the first valid client depending on the direction instead of a first client in the workspace ([2a72d8b](https://github.com/H3rmt/hyprshell/commit/2a72d8ba63ff7c20412d1a9a1dcd7da861c8204b))
* show recent windows on one screen only ([f6a3016](https://github.com/H3rmt/hyprshell/commit/f6a301689827ebb27afc10d445715c070a5762f1))
...
* some focus fixes ([9fa8009](https://github.com/H3rmt/hyprshell/commit/9fa80093f943f6941aeaeb424a262cb3b4c40ec6))
* sort launcher applications by shorted exec instead of full (removed /bin/flatpak...) ([b17a393](https://github.com/H3rmt/hyprshell/commit/b17a393b04201beab8b582a340d1bb80bef5cda2))
* speedup animation ([179ca7b](https://github.com/H3rmt/hyprshell/commit/179ca7b45e865875584a4c658a0455ea00af0bc6))
* switch window if no results are present in launcher ([50a81a0](https://github.com/H3rmt/hyprshell/commit/50a81a0503f8f259374fdafab73e383f930902fe))
* toml config plugins for launcher ([5858cfd](https://github.com/H3rmt/hyprshell/commit/5858cfd475f1e3b604f6d035bdc5507977833af5))
* try all config extensions if file missing ([6cd4799](https://github.com/H3rmt/hyprshell/commit/6cd4799198c7b170537135a611c8ed88b97aa62f))
* try to fix publication to creates.io ([c911a07](https://github.com/H3rmt/hyprshell/commit/c911a078e40655fd869df317479a6a93cce508b2))
* update documentation ([229921d](https://github.com/H3rmt/hyprshell/commit/229921d82167d59670cdeab488677b372ecafe73))
* Update Nix Package ([a147d38](https://github.com/H3rmt/hyprshell/commit/a147d385ee5928e0616d232f741657069242272f))
* use char instead of String for key for websearch plugins ([eba4282](https://github.com/H3rmt/hyprshell/commit/eba42823569cbf19dcb35cf37cc78db7bcdb0e3b))
* use correct path to generate config ([112e7d2](https://github.com/H3rmt/hyprshell/commit/112e7d26acde6dd98805b69b807b6a5004763a96))
* use dbus to open if no browser was found ([c074a56](https://github.com/H3rmt/hyprshell/commit/c074a56ac7603c14754a4b20a65eeb095e2a103d))
* use new ini parser everywhere ([8db2643](https://github.com/H3rmt/hyprshell/commit/8db2643a7c5e5b51a316d4654268c38bc2202be4))
...
* (1/2) add a plugin system for launcher ([accd552](https://github.com/H3rmt/hyprshell/commit/accd552b264c7f38a0724a5681862fc7bd820ec7))
* (2/3) add a plugin system for launcher ([3930331](https://github.com/H3rmt/hyprshell/commit/39303311680d49c4733a825782b2f153fc71abd9))
* (3/3) add a plugin system for launcher ([7a18308](https://github.com/H3rmt/hyprshell/commit/7a18308007625e667e195f8083af3a168c82514c))
* (4/4) final launcher fixes ([9fba20f](https://github.com/H3rmt/hyprshell/commit/9fba20f2b1c50137364785a63e0dd0fb6968e029))
* activate submap from hyprshell bin instead of hyprctl ([58582c8](https://github.com/H3rmt/hyprshell/commit/58582c88a835d717c05cdc57cc3bd89c4934b5a3))
* added Appimage support ([56694ad](https://github.com/H3rmt/hyprshell/commit/56694ad6f544ce64739e23686c11eb0be2ff025b))
* better errors if config invalid ([15f4021](https://github.com/H3rmt/hyprshell/commit/15f402190f366a53d960f7751d5f8c2bdf48df44))
* better errors if config invalid ([e92bc49](https://github.com/H3rmt/hyprshell/commit/e92bc4986567d0e9a74d409b1ab022d2006f44b8))
* better program output ([f3530ba](https://github.com/H3rmt/hyprshell/commit/f3530ba978c946d0026c63bd89cdd91110a3b6cd))
* clippy fixes ([7f8b02f](https://github.com/H3rmt/hyprshell/commit/7f8b02fa18fed626491c8c1f3debae5c73a681c6))
* fixing popups with gtk_layer_shell and KeyboardMode::Exclusive (1/?) ([893baeb](https://github.com/H3rmt/hyprshell/commit/893baeb7c2d01ffa4c10e9e4f5e75fd67e2df52f))
* improve submap handling and restart logic handling SIGTERM ([b4a8f2e](https://github.com/H3rmt/hyprshell/commit/b4a8f2e61d503fb6eee7850ce1ce6f33dfab72bf))
* moved to plugin struct instead of an array ([009712f](https://github.com/H3rmt/hyprshell/commit/009712f37b9eb871327d5848a5c0eb1db4b64615))
...
* remove mallopt ([8ee5732](https://github.com/H3rmt/hyprshell/commit/8ee57320605781f8f0c4c0472740db21ea79df31))
...
* remove theme check ([c074a56](https://github.com/H3rmt/hyprshell/commit/c074a56ac7603c14754a4b20a65eeb095e2a103d))
* show name in data launch-history cmd ([162dec5](https://github.com/H3rmt/hyprshell/commit/162dec534e773c7f3b8f85dedd3d0e5c1d2d2109))
* store engines in websearch in separate value in config ([be536c2](https://github.com/H3rmt/hyprshell/commit/be536c2b04eb459b4c8e7cf8b1f64083c0f042a1))


### Documentation

* add CSS docs ([4394240](https://github.com/H3rmt/hyprshell/commit/43942408b0febe18026e278d2e4cffd7eece25db))
* added documentation for the config file and CSS ([1cff3a2](https://github.com/H3rmt/hyprshell/commit/1cff3a288a54f89fbdfd9ea1d31118d9f3f47c8c))
* CSS docs ([7bc3982](https://github.com/H3rmt/hyprshell/commit/7bc398262a5c6e3f252298cd2770ced0de121544))
* fix css explain images ([d86d566](https://github.com/H3rmt/hyprshell/commit/d86d5667201031915100391c1eeb9571e763f370))
* update docs ([da673dc](https://github.com/H3rmt/hyprshell/commit/da673dc82d5e3b25c2c773fd0442a544a385bf5d))
* update images ([16c2394](https://github.com/H3rmt/hyprshell/commit/16c2394180b2b337c31c228316a8a5a80a9a168d))
* update readme ([8973131](https://github.com/H3rmt/hyprshell/commit/89731314f4ec2f834a10e93c215f0af512ca0f8d))
* update readme and configure ([145e02f](https://github.com/H3rmt/hyprshell/commit/145e02fd203307927bf474c6ecdfd36ff1119135))
* updated README ([ecdcdfe](https://github.com/H3rmt/hyprshell/commit/ecdcdfef8730c5a21bc413a99229bc1529ed2c41))


### Continuous Integration

* fix ci release ([a24657b](https://github.com/H3rmt/hyprshell/commit/a24657bb9e237e69ff2f8687577114c25de921fe))
* fix ci release ([e02df4a](https://github.com/H3rmt/hyprshell/commit/e02df4a193718664762ba8d7e22c63814f061de3))
* fix ci release ([d8d481d](https://github.com/H3rmt/hyprshell/commit/d8d481d672809a4f8907a156eed1705caa27a9aa))
* fix release-please again ([824bf03](https://github.com/H3rmt/hyprshell/commit/824bf032ab3b131121b16d9c16ce9f6a5215c580))
* fix release-please again ([bce2335](https://github.com/H3rmt/hyprshell/commit/bce23355cd3f477e95179acadd5d1401544b1822))
* fix releases ([06ad9fc](https://github.com/H3rmt/hyprshell/commit/06ad9fc8cc85a4a6fe3584510bce0efbd1aa1425))
* switch CI back to normal repo ([9aec89c](https://github.com/H3rmt/hyprshell/commit/9aec89c4705d1c9683d30274aa442512e3665493))
